...
Atomization is generally divided into two 

Liquid fuel injected into combustion chamber cannot be evaporated straightforward because the is not high enough. Hence, this specific surface is increased by breaking the continuous liquid jet into smaller fragments in the process of atomization. \citepColor[lefebvre_atomization_2017] defines atomization as \textsl{the process by which a liquid jet or sheet is disintegrated by the kinetic energy of the liquid, by the exposure to
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{./part0_intro/jicf_breakup_regime_wu}
...
Numerical simulations are a powerful tool for studying the physical mechanisms inside gas turbines, as they give access to all the variables of interest and to physical regions which are unreachable with experimental facilities. Furthermore, for reactive problems they are     
