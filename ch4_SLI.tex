...
Chapter \ref{ch3:disperse_phase_methods} ...

In particular, $\S$\ref{sec:ch3_state_art_lagrangian_injection} presented a literature review of models for performing lagrangian injection in MSFI systems. 
