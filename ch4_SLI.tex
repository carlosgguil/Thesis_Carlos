...
% NOTE: we use the general formulation for sampling surfaces as specified in latex-equations.
...
Mention \ref{sorensen_numerical_2002} and \citeColor[benard_large-eddy_2018].
