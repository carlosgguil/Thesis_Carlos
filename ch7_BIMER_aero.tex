...
\end{subfigure}
\caption[Turbulent structures in BIMER]{Turbulent structures in BIMER. \textsl{Left}: PVC visualization (blue) by iso-contour of statis pressure. \textsl{Right}: Vortical structures shown by iso-surface of Q-criterion}
