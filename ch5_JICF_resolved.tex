...
3 simulations have been performed, one per mesh. For flow establishment, the simulations are run for a total physical time of 6 times the flow-through time, i.e. 7.2 ms. From this stage on, statistics are collected. Each simulation has run for a total time of \textbf{??}, which corresponds to $\textbf{??}$ flow through times. This physical time ensures that the parameters of interest, such as mean and RMS velocities are converged.

To illustrate the flow establishment, we are going to look at the evolution of the mean axial velocity $\langle u \rangle$ and mean Turbulent Kinetic Energy (TKE) averaged along the line shown in Figure \ref{fig:mesh_convergence_line_averages}. At this point,  located right upstream the injection nozzle. 

\begin{subequations}
\label{eq:line_averaged_u_and_TKE}
\begin{empheq}{align}
\langle u \rangle &= \frac{1}{L} \int_0^L u \left( z \right) dz  \\
\langle \mathrm{TKE} \rangle &= \frac{1}{L} \int_0^L \frac{1}{2} \left( \overline{u'\left( z \right)^2} + \overline{v'\left( z \right)^2} + \overline{w'\left( z \right)^2} \right) dz 
\end{empheq}
\end{subequations}
...
\begin{subfigure}[b]{0.45\textwidth}
   ...
   %\label{}
\end{subfigure}
\caption{Convergence of mean axial velocity and TKE with mesh resolution}
\label{fig:mesh_convergence_line_averages}
\end{figure}



Instantaneous snapshots of the fluctuating axial component $u'$ in the middle plane are shown in Figure \textbf{??}. The black contours denote the lines with $u' = 0$. As shown ... 
...
\caption[Instantaneous $u'$ fields from gaseous simulation for the high We case]{Instantaneous $u'$ fields from gaseous simulation for the high We case. The right column shows a zommed-in view of the dashed rectangle from the left column. The black contours indicate the lines with zero instantaneous fluctuation $u' = 0$. From top to bottom $\Delta x_\mathrm{ups} = 1, 0.5, 0.3$ mm.}
\label{fig:ics_mesh_independency_study_up_fields}
\end{figure}

The mean velocity and TKE profiles along the line are shown in Figure \textbf{XX}...

In order to compare quantitatively the difference between both meshes, the signals of $u'$ have been monitored at the probes shown by the black dots in Figure ??. Two probes per simulation have been located: one at 1 mm downstream the gaseous inlet (x = 1 mm) and another one 1 mm upstream the liquid injection nozzle (x = 119 mm). The capability of the meshes to transport the resolved turbulent scales, which is of the order of the turbulent fluctuations displayed in Table \ref{tab:jicf_operating_conditions_turbulent_injection_parameters}, is then verified by comparing the fluctuations at both probes.  The velocity signals and normalised spectra are shown in Figure \textbf{??}. As observed ...
...
%\begin{subfigure}[b]{0.45\textwidth}
%	\centering
%   \includegraphics[scale=0.10]{./part2_developments/figures_ch5_resolved_JICF/results_ics_mesh_convergence/up_dx1p0.eps}
%   %\caption{}
%   %\label{} 
%\end{subfigure}
%\hfill
%\begin{subfigure}[b]{0.45\textwidth}
%	\centering
%   \includegraphics[scale=0.10]{./part2_developments/figures_ch5_resolved_JICF/results_ics_mesh_convergence/spectra_linear_scale_dx1p0.eps}
%   \caption{}
%   %\label{}
%\end{subfigure}
%
...
%\begin{subfigure}[b]{0.45\textwidth}
%	\centering
%   \includegraphics[scale=0.10]{./part2_developments/figures_ch5_resolved_JICF/results_ics_mesh_convergence/up_dx0p5.eps}
%   %\caption{}
%   %\label{} 
%\end{subfigure}
%\hfill
%\begin{subfigure}[b]{0.45\textwidth}
%	\centering
%   \includegraphics[scale=0.10]{./part2_developments/figures_ch5_resolved_JICF/results_ics_mesh_convergence/spectra_linear_scale_dx0p5.eps}
%   \caption{}
%   %\label{}
%\end{subfigure}
%
...
%\begin{subfigure}[b]{0.45\textwidth}
%	\centering
%   \includegraphics[scale=0.10]{./part2_developments/figures_ch5_resolved_JICF/results_ics_mesh_convergence/up_dx0p3.eps}
%   %\caption{}
%   %\label{} 
%\end{subfigure}
%\hfill
%\begin{subfigure}[b]{0.45\textwidth}
%	\centering
%   \includegraphics[scale=0.10]{./part2_developments/figures_ch5_resolved_JICF/results_ics_mesh_convergence/spectra_linear_scale_dx0p3.eps}
%   \caption{}
%   %\label{}
%\end{subfigure}
%
%\caption[YAP]{YAP}
%\label{fig:ics_mesh_independency_study}
%\end{figure}
...
\begin{figure}[ht]
\centering
\includeinkscape[inkscapelatex=false,scale=0.9]{./part2_developments/figures_ch5_resolved_JICF/JICF_establishment_UG100_lateral}
...
\begin{figure}[ht]
\centering
\includeinkscape[inkscapelatex=false,scale=0.9]{./part2_developments/figures_ch5_resolved_JICF/JICF_establishment_UG100_front}
...
\begin{figure}[ht]
\centering
\includeinkscape[inkscapelatex=false,scale=0.9]{./part2_developments/figures_ch5_resolved_JICF/JICF_establishment_UG100_top}
...
\begin{figure}[ht]
\centering
\includeinkscape[inkscapelatex=false,scale=0.9]{./part2_developments/figures_ch5_resolved_JICF/JICF_establishment_UG75_lateral}
...
\begin{figure}[ht]
\centering
\includeinkscape[inkscapelatex=false,scale=0.9]{./part2_developments/figures_ch5_resolved_JICF/JICF_establishment_UG75_front}
...
\begin{figure}[ht]
\centering
\includeinkscape[inkscapelatex=false,scale=0.9]{./part2_developments/figures_ch5_resolved_JICF/JICF_establishment_UG75_top}
...
\subsection{Dense core characterization}
