...
References: \textbf{2010:Wang}, \textbf{2018:prakash}, \citeColor[patil_liquid_2021]
...
%\end{subfigure}
%   \caption{Variaions with time of the dense core breakup point coordinates $x_\mathrm{b}, z_\mathrm{b}$ and width $w$.}
...
\end{subfigure}
   \caption{Evolution of mean parameters of dense core}
