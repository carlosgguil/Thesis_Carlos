...
u = spray.ux/params_simulation_UG100['U_G']
u_mean = spray.u_mean[0]/params_simulation_UG100['U_G']
u_VW   = spray.u_mean_volume_weighted[0]/params_simulation_UG100['U_G']
v = spray.uy/params_simulation_UG100['U_L']
v_mean = spray.u_mean[1]/params_simulation_UG100['U_L']
v_VW   = spray.u_mean_volume_weighted[1]/params_simulation_UG100['U_L']
w = spray.uz
w_mean = spray.u_mean[2]/params_simulation_UG100['U_L']
w_VW   = spray.u_mean_volume_weighted[2]/params_simulation_UG100['U_L']

# scatterplot u x
plt.figure(figsize=figsize_)
#plt.scatter(spray.diam.values, spray.ux, facecolors='none', s=marker_size_, color=color_markers_) 
plt.scatter(spray.diam.values, u, c = spray.z, facecolors='none', s=marker_size_, label = label_legend_scatter, cmap=cm.seismic) 
...
plt.scatter(spray.diam.values, v, c = spray.y, facecolors='none', s=marker_size_, cmap=cm.seismic) 
...
w = spray.uz/params_simulation_UG100['U_L']
w_mean = spray.u_mean[2]/params_simulation_UG100['U_L']
w_VW   = spray.u_mean_volume_weighted[2]/params_simulation_UG100['U_L']
...
plt.scatter(spray.diam.values, w, c = spray.z, facecolors='none', s=marker_size_, cmap=cm.seismic) 
