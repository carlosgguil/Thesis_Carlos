...
i = 0; plt.plot(tp_x05[i], SMD_x05[i], color='black',label=labels_[i]) 
i = 1; plt.plot(tp_x05[i], SMD_x05[i], color='grey',label=labels_[i])
i = 2; plt.plot(tp_x05[i], SMD_x05[i], color='blue',label=labels_[i])
i = 3; plt.plot(tp_x05[i], SMD_x05[i], color='green',label=labels_[i]) 
i = 4; plt.plot(tp_x05[i], SMD_x05[i], '--', color='green',label=labels_[i]) 
...
# x = 10 mm
plt.figure(figsize=figsize_)
i = 0; plt.plot(tp_x10[i], SMD_x10[i], color='black') 
i = 1; plt.plot(tp_x10[i], SMD_x10[i], color='grey')
i = 2; plt.plot(tp_x10[i], SMD_x10[i], color='blue')
i = 3; plt.plot(tp_x10[i], SMD_x10[i], color='green') 
i = 4; plt.plot(tp_x10[i], SMD_x10[i], '--', color='green') 
plt.xlabel(x_label_time)
plt.ylabel(y_label_SMD)
#plt.xticks([0,5,10,15,20])
plt.grid()
#plt.title(label_mean_xb+r' $\mathrm{convergence~graph}$')
plt.tight_layout()
plt.savefig(folder_manuscript+'SMD_evol_at_x10.pdf')
plt.show()
plt.close()

# x = 15 mm
plt.figure(figsize=figsize_)
i = 0; plt.plot(tp_x15[i], SMD_x15[i], color='grey') 
i = 1; plt.plot(tp_x15[i], SMD_x15[i], color='green')
plt.xlabel(x_label_time)
plt.ylabel(y_label_SMD)
#plt.xticks([0,5,10,15,20])
plt.grid()
plt.tight_layout()
plt.savefig(folder_manuscript+'SMD_evol_at_x15.pdf')
plt.show()
plt.close()
...
# x = 05 mm
plt.figure(figsize=figsize_)
i = 0; plt.plot(tp_x05[i], Ql_x05[i], color='black',label=labels_[i]) 
i = 1; plt.plot(tp_x05[i], Ql_x05[i], color='grey',label=labels_[i])
i = 2; plt.plot(tp_x05[i], Ql_x05[i], color='blue',label=labels_[i])
i = 3; plt.plot(tp_x05[i], Ql_x05[i], color='green',label=labels_[i]) 
i = 4; plt.plot(tp_x05[i], Ql_x05[i], '--', color='green',label=labels_[i]) 
plt.xlabel(x_label_time)
...
#plt.title(label_mean_xb+r' $\mathrm{convergence~graph}$')
plt.tight_layout()
plt.savefig(folder_manuscript+'Ql_evol_at_x05.pdf')
plt.show()
plt.close()
...
# x = 10 mm
plt.figure(figsize=figsize_)
i = 0; plt.plot(tp_x10[i], Ql_x10[i], color='black') 
i = 1; plt.plot(tp_x10[i], Ql_x10[i], color='grey')
i = 2; plt.plot(tp_x10[i], Ql_x10[i], color='blue')
i = 3; plt.plot(tp_x10[i], Ql_x10[i], color='green') 
i = 4; plt.plot(tp_x10[i], Ql_x10[i], '--', color='green') 
plt.xlabel(x_label_time)
plt.ylabel(y_label_Ql)
#plt.xticks([0,5,10,15,20])
plt.ylim((0,5000))
...
#plt.title(label_mean_xb+r' $\mathrm{convergence~graph}$')
plt.tight_layout()
plt.savefig(folder_manuscript+'Ql_evol_at_x10.pdf')
plt.show()
plt.close()

# x = 15 mm
plt.figure(figsize=figsize_)
i = 0; plt.plot(tp_x15[i], Ql_x15[i], color='grey') 
i = 1; plt.plot(tp_x15[i], Ql_x15[i], color='green')
plt.xlabel(x_label_time)
plt.ylabel(y_label_Ql)
#plt.xticks([0,5,10,15,20])
plt.ylim((0,5000))
plt.grid()
plt.tight_layout()
plt.savefig(folder_manuscript+'Ql_evol_at_x15.pdf')
plt.show()
plt.close()
