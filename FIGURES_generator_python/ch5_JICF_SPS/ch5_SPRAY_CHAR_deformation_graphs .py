...
y_label_alpha_beta_mean = r'$\overline{\alpha}, \overline{\beta}$'
...
for i in range(len(sprays_list_all)):
    ...
    for j in range(len(case)):
        # Time-averaged
        alpha_mean_val.append(case[j].alpha.mean)
        alpha_rms_val.append(case[j].alpha.std)
        beta_mean_val.append(case[j].beta.mean)
        beta_rms_val.append(case[j].beta.std)
        # Volume-weighted
        '''
...
i = 0
ax  = plt.gca()
ax.plot(x_dx10, alpha_mean_cases[i], '-ok', label=labels_OP[i])
#ax.plot(x_dx10, alpha_mean_vw_cases[i], '--ok')
i = 1
ax  = plt.gca()
ax.plot(x_dx20, alpha_mean_cases[i], '-ob', label=labels_OP[i])
...
i = 0
ax  = plt.gca()
ax.plot(x_dx10, beta_mean_cases[i], '-ok', label=labels_OP[i])
#ax.plot(x_dx10, beta_mean_vw_cases[i], '--ok')
i = 1
ax  = plt.gca()
ax.plot(x_dx20, beta_mean_cases[i], '-ob', label=labels_OP[i])
...
i = 4
ax  = plt.gca()
ax.plot(x_dx10, alpha_mean_cases[i], '-or', label=labels_OP[i])
...
i = 4
ax  = plt.gca()
ax.plot(x_dx10, beta_mean_cases[i], '-or', label=labels_OP[i])
...
ax.plot(x_dx10, alpha_mean_cases[i], '-ok', label=labels_OP[i])
#ax.plot(x_dx10, alpha_mean_vw_cases[i], '--ok')
ax.plot(x_dx10, beta_mean_cases[i], '-ok')
#ax.plot(x_dx10, alpha_mean_vw_cases[i], '--ok')
i = 1
ax  = plt.gca()
ax.plot(x_dx20, alpha_mean_cases[i], '-ob', label=labels_OP[i])
ax.plot(x_dx20, beta_mean_cases[i], '-ob')
#ax.plot(x_dx20, alpha_mean_vw_cases[i], '--ob')
ax.plot([0,100],[1]*2,'--k')
ax.set_xlim(4.5,15.5)
ax.set_xticks([5,10,15])
...
ax  = plt.gca()
ax.plot(x_dx10, alpha_mean_cases[i], '-or', label=labels_OP[i])
ax.plot(x_dx10, beta_mean_cases[i], '-or')
#ax.plot(x_dx10, alpha_mean_vw_cases[i], '--or')
ax.plot([0,100],[1]*2,'--k')
ax.set_xlim(4.5,15.5)
ax.set_xticks([5,10,15])
