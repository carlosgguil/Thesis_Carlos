...
i = 4
ax  = plt.gca()
ax.plot(x_dx10, uz_mean_cases[i], '-or', label=labels_OP[i])
ax.plot(x_dx10, uz_mean_vw_cases[i], '--or')
ax.set_xlim(4.5,15.5)
ax.set_xticks([5,10,15])
ax.set_xlabel(x_label_)
ax.set_ylabel(y_label_uz_mean)
...
i = 4
ax  = plt.gca()
ax.plot(x_dx10, uz_rms_cases[i], '-or', label=labels_OP[i])
ax.plot(x_dx10, uz_rms_vw_cases[i], '--or')
ax.set_xlim(4.5,15.5)
ax.set_xticks([5,10,15])
ax.set_xlabel(x_label_)
ax.set_ylabel(y_label_uz_rms)
