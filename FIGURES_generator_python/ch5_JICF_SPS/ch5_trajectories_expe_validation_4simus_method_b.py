...
data_op1_dx20 = pd.read_csv(directory_op1_dx20+'/method_b_data_trajectory.csv')
L2_op1_dx20   = pd.read_csv(directory_op1_dx20+'/method_b_data_L2.csv')


# OP1, dx = 20 µm no turb.
directory_op1_dx20_no_turb = folder+'/'+op1+'/dx20_no_turbulence'
data_op1_dx20_no_turb = pd.read_csv(directory_op1_dx20_no_turb+'/method_b_data_trajectory.csv')
L2_op1_dx20_no_turb   = pd.read_csv(directory_op1_dx20_no_turb+'/method_b_data_L2.csv')


# OP1, dx = 10 µm
directory_op1_dx10 = folder+'/'+op1+'/dx10'
data_op1_dx10 = pd.read_csv(directory_op1_dx10+'/method_b_data_trajectory.csv')
L2_op1_dx10   = pd.read_csv(directory_op1_dx10+'/method_b_data_L2.csv')

# OP2, dx = 20 µm
directory_op2_dx20 = folder+'/'+op2+'/dx20'
data_op2_dx20 = pd.read_csv(directory_op2_dx20+'/method_b_data_trajectory.csv')
L2_op2_dx20   = pd.read_csv(directory_op2_dx20+'/method_b_data_L2.csv')

# OP2, dx = 10 µm
directory_op2_dx10 = folder+'/'+op2+'/dx10'
data_op2_dx10 = pd.read_csv(directory_op2_dx10+'/method_b_data_trajectory.csv')
L2_op2_dx10   = pd.read_csv(directory_op2_dx10+'/method_b_data_L2.csv')
