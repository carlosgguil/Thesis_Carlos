...
#figsize_2_in_a_row = (FFIG*25,FFIG*15) 
figsize_2_in_a_row = (FFIG*35,FFIG*15)
...
label_xD_03p33 = r'$x_c = 1~\mathrm{mm}$'
label_xD_05p00 = r'$x_c = 1.5~\mathrm{mm}$'
label_xD_06p67 = r'$x_c = 2~\mathrm{mm}$'
label_xD_08p33 = r'$x_c = 2.5~\mathrm{mm}$'
label_xD_10p00 = r'$x_c = 3~\mathrm{mm}$'
label_xD_11p66 = r'$x_c = 3.5~\mathrm{mm}$'
...
Q_inst_DX10_x08p33 = df_DX10_x08p33['Q_t_xD_08p33'].values
...
Q_inst_DX10_x10p00 = df_DX10_x10p00['Q_t_xD_10p00'].values
...
plt.plot(t_DX10_x05p00, Q_inst_DX10_x05p00, 'b', label=label_xD_05p00)
plt.plot(t_DX10_x06p67, Q_inst_DX10_x06p67, 'k', label=label_xD_06p67)
#plt.plot(t_DX10_x08p33, Q_inst_DX10_x08p33, 'r', label=label_xD_08p33)
#plt.plot(t_DX10_x10p00, Q_inst_DX10_x10p00, 'g', label=label_xD_08p33)
...
ax1.plot(t_DX10_x05p00, Q_mean_DX10_x05p00, 'b', label=label_xD_05p00)
ax1.plot(t_DX10_x06p67, Q_mean_DX10_x06p67, 'k', label=label_xD_06p67)
ax1.plot(t_DX10_x08p33, Q_mean_DX10_x08p33, 'r', label=label_xD_08p33)
ax1.plot(t_DX10_x10p00, Q_mean_DX10_x10p00, 'g', label=label_xD_10p00)
...
#ax1.xaxis.set_ticks(tp_ticks_DX10)
ax1.xaxis.set_ticks([])
#ax1.legend(loc='best',fontsize=45*FFIG,ncol=1)
...
ax2.plot(t_DX15_x05p00, Q_mean_DX15_x05p00, 'b', label=label_xD_05p00)
ax2.plot(t_DX15_x06p67, Q_mean_DX15_x06p67, 'k', label=label_xD_06p67)
ax2.plot(t_DX15_x08p33, Q_mean_DX15_x08p33, 'r', label=label_xD_08p33)
ax2.plot(t_DX15_x10p00, Q_mean_DX15_x10p00, 'g', label=label_xD_10p00)
#ax2.plot(t_DX15_x11p66, Q_mean_DX15_x11p66, '--b', label=label_xD_11p66)
ax2.set_title(label_DX15)
#ax2.xaxis.set_ticks(tp_ticks_DX15)
ax2.xaxis.set_ticks([])
ax2.legend(loc='upper left',fontsize=45*FFIG,ncol=3,
...
#ax1.set_title(label_UG75_DX20)
ax1.xaxis.set_ticks(tp_ticks_DX10)
#ax1.yaxis.set_ticks([0,100,200,300])
#ax1.legend(loc='best',fontsize=45*FFIG,ncol=1)
...
ax2.legend(loc='upper left',fontsize=50*FFIG,ncol=3,
           bbox_to_anchor=(-1.,1.0))



ax1.set(ylabel = y_label_Ql_mean_perp)
for ax in [ax1,ax2]:
    ax.label_outer()
    ax.set(xlabel=x_label_time)
    #ax.grid()
...
ax1.plot(t_DX10_x05p00, Q_RMS_DX10_x05p00, 'b', label=label_xD_05p00)
ax1.plot(t_DX10_x06p67, Q_RMS_DX10_x06p67, 'k', label=label_xD_06p67)
ax1.plot(t_DX10_x08p33, Q_RMS_DX10_x08p33, 'r', label=label_xD_08p33)
ax1.plot(t_DX10_x10p00, Q_RMS_DX10_x10p00, 'g', label=label_xD_10p00)
...
ax2.plot(t_DX15_x05p00, Q_RMS_DX15_x05p00, 'b', label=label_xD_05p00)
ax2.plot(t_DX15_x06p67, Q_RMS_DX15_x06p67, 'k', label=label_xD_06p67)
ax2.plot(t_DX15_x08p33, Q_RMS_DX15_x08p33, 'r', label=label_xD_08p33)
ax2.plot(t_DX15_x10p00, Q_RMS_DX15_x10p00, 'g', label=label_xD_10p00)
...
ax1.set(ylabel = y_label_Ql_RMS_perp)
for ax in [ax1,ax2]:
    ax.label_outer()
    ax.set(xlabel=x_label_time)
    #ax.grid()
...
#%% Bar graphs iso-x (without DX07)


r1 = np.arange(len(cases[1:]))


Q_x_mean_xD_05p00 = [Q_mean_DX10_x05p00[-1],
                     Q_mean_DX15_x05p00[-1]]
Q_x_mean_xD_06p67 = [Q_mean_DX10_x06p67[-1],
                     Q_mean_DX15_x06p67[-1]]
Q_x_mean_xD_08p33 = [Q_mean_DX10_x08p33[-1],
                     Q_mean_DX15_x08p33[-1]]
Q_x_mean_xD_10p00 = [Q_mean_DX10_x10p00[-1],
                     Q_mean_DX15_x10p00[-1]]

Q_x_RMS_xD_05p00 = [Q_RMS_DX10_x05p00[-1],
                     Q_RMS_DX15_x05p00[-1]]
Q_x_RMS_xD_06p67 = [Q_RMS_DX10_x06p67[-1],
                     Q_RMS_DX15_x06p67[-1]]
Q_x_RMS_xD_08p33 = [Q_RMS_DX10_x08p33[-1],
                    Q_RMS_DX15_x08p33[-1]]
Q_x_RMS_xD_10p00 = [Q_RMS_DX10_x10p00[-1],
                    Q_RMS_DX15_x10p00[-1]]
...
plt.plot([r1[0]-barWidth*2,r1[-1]+barWidth*2],[Q_inj]*2, '--k', label=label_Ql_injected,linewidth=4*FFIG)
plt.bar(r1-barWidth*1.5, Q_x_mean_xD_05p00, yerr=Q_x_RMS_xD_05p00, width=barWidth, color='blue', edgecolor='white', label=label_xD_05p00, capsize=barWidth*100)
plt.bar(r1-barWidth*0.5, Q_x_mean_xD_06p67, yerr=Q_x_RMS_xD_06p67, width=barWidth, color='grey', edgecolor='white', label=label_xD_06p67, capsize=barWidth*100)
plt.bar(r1+barWidth*0.5, Q_x_mean_xD_08p33, yerr=Q_x_RMS_xD_08p33, width=barWidth, color='red', edgecolor='white', label=label_xD_08p33, capsize=barWidth*100)
plt.bar(r1+barWidth*1.5, Q_x_mean_xD_10p00, yerr=Q_x_RMS_xD_10p00, width=barWidth, color='green', edgecolor='white', label=label_xD_10p00, capsize=barWidth*100)
#plt.xlabel('Case')#, fontweight='bold')
plt.ylabel(y_label_Ql_mean_perp)
plt.ylim((0,400))
plt.xticks([r for r in range(len(cases[1:]))], cases[1:])
