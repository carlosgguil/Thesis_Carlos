...
y_label_ux = r'$u_c~[\mathrm{m}~\mathrm{s}^{-1}]$'
y_label_uy = r'$v_c~[\mathrm{m}~\mathrm{s}^{-1}]$'
y_label_uz = r'$w_c~[\mathrm{m}~\mathrm{s}^{-1}]$'
...
u = spray.ucx
u_mean = spray.uc_mean[0]
u_VW   = spray.uc_mean_volume_weighted[0]
v = spray.ucy
v_mean = spray.uc_mean[1]
v_VW   = spray.uc_mean_volume_weighted[1]
w = spray.ucz
w_mean = spray.uc_mean[2]
w_VW   = spray.uc_mean_volume_weighted[2]

# scatterplot u x
plt.figure(figsize=figsize_)
#plt.scatter(spray.diam.values, spray.ux, facecolors='none', s=marker_size_, color=color_markers_) 
plt.scatter(spray.diam.values, u, c = spray.zc, facecolors='none', s=marker_size_, label = label_legend_scatter, cmap=cm.seismic) 
