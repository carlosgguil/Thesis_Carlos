...
sps_DX15_xD05p00 = sprays_list_DX15[0]
sps_DX15_xD06p67 = sprays_list_DX15[1]
sps_DX15_xD08p33 = sprays_list_DX15[2]
sps_DX15_xD10p00 = sprays_list_DX15[3]

sps_DX10_xD05p00 = sprays_list_DX10[0]
sps_DX10_xD06p67 = sprays_list_DX10[1]
sps_DX10_xD08p33 = sprays_list_DX10[2]
sps_DX10_xD10p00 = sprays_list_DX10[3]


sprays_xD05p00 = [sps_DX15_xD05p00,  sps_DX10_xD05p00]
sprays_xD06p67 = [sps_DX15_xD06p67,  sps_DX10_xD06p67]
sprays_xD08p33 = [sps_DX15_xD08p33,  sps_DX10_xD08p33]
sprays_xD10p00 = [sps_DX15_xD10p00,  sps_DX10_xD10p00]
...
Ql_SLI_xD08p33 = np.array([sps_DX10_xD08p33.Q, sps_DX15_xD08p33.Q])*SCALE_FACTOR
Ql_SLI_xD10p00 = np.array([sps_DX10_xD10p00.Q, sps_DX15_xD10p00.Q])*SCALE_FACTOR
...
df_DX15_xD08p33 = pd.read_csv(folder_ibs+'/overall_integrated_fluxes/dx15p0_Q_xD_08p33.csv')
df_DX15_xD10p00 = pd.read_csv(folder_ibs+'/overall_integrated_fluxes/dx15p0_Q_xD_10p00.csv')
...
df_DX10_xD08p33 = pd.read_csv(folder_ibs+'/overall_integrated_fluxes/dx10p0_Q_xD_08p33.csv')
df_DX10_xD10p00 = pd.read_csv(folder_ibs+'/overall_integrated_fluxes/dx10p0_Q_xD_10p00.csv')
...
Q_mean_DX15_xD08p33 = df_DX15_xD08p33['Q_t_xD_08p33_mean_evol'].values
Q_mean_DX15_xD10p00 = df_DX15_xD10p00['Q_t_xD_10p00_mean_evol'].values
...
Q_mean_DX10_xD08p33 = df_DX10_xD08p33['Q_t_xD_08p33_mean_evol'].values
Q_mean_DX10_xD10p00 = df_DX10_xD10p00['Q_t_xD_10p00_mean_evol'].values
...
Q_x_mean_xD08p33 = [Q_mean_DX10_xD08p33[-1], Q_mean_DX15_xD08p33[-1]]
Q_x_mean_xD10p00 = [Q_mean_DX10_xD10p00[-1], Q_mean_DX10_xD10p00[-1]]
...
# xD = 05.00
plt.bar(r1-barWidth*1.8, Q_x_mean_xD05p00, width=barWidth/2, color='blue', edgecolor='white', label=label_xD05p00)
plt.bar(r1-barWidth*1.3, Ql_SLI_xD05p00, width=barWidth/2, color='blue', edgecolor='black', hatch = pattern_bars_SLI)
# xD = 06.67
plt.bar(r1-barWidth*0.25, Q_x_mean_xD06p67, width=barWidth/2, color='grey', edgecolor='white', label=label_xD06p67)
plt.bar(r1-barWidth*0.75, Ql_SLI_xD06p67, width=barWidth/2, color='grey', edgecolor='black', hatch = pattern_bars_SLI)
# xD = 08.33
plt.bar(r1+barWidth*0.275, Q_x_mean_xD08p33, width=barWidth/2, color='red', edgecolor='white', label=label_xD08p33)
plt.bar(r1+barWidth*0.775, Ql_SLI_xD08p33, width=barWidth/2, color='red', edgecolor='black', hatch = pattern_bars_SLI)
# xD = 10.00
plt.bar(r1+barWidth*1.3, Q_x_mean_xD10p00, width=barWidth/2, color='green', edgecolor='white', label=label_xD10p00)
plt.bar(r1+barWidth*1.8, Ql_SLI_xD10p00, width=barWidth/2, color='green', edgecolor='black', hatch = pattern_bars_SLI)
