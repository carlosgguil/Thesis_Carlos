...
folder_manuscript='C:/Users/Carlos Garcia/Documents/GitHub/Thesis_Carlos/part2_developments/figures_ch6_lagrangian_JICF/params_spray_velocities/profiles/'
...
folder_baseline = folder + 'apte_model_calibration_u_vw_lognorm/k1_0p05_k2_1p0/store_variables/'
folder_u_arithmetic = folder + 'param_u_averaging/u_arithmetic_D_LN/store_variables/'
folder_r_zero = folder + 'param_u_law/r_zero/store_variables/'
folder_r_uniform = folder + 'param_u_law/r_uniform/store_variables/'

label_expe  = r'$\mathrm{Experiments}$'
label_baseline = r'$u_\mathrm{VW},~r~\mathrm{Gauss}$'
label_u_arithmetic = r'$\overline{u},~r~\mathrm{Gauss}$'
label_r_zero = r'$u_\mathrm{VW},~r~\mathrm{zero}$'
label_r_uniform = r'$u_\mathrm{VW},~r~\mathrm{uniform}$'

folders = [folder_baseline,
           folder_u_arithmetic,
           folder_r_zero,
           folder_r_uniform]

cases = ['baseline',
         'u_arithmetic_average',
         'r_zero',
         'r_uniform']

labels_ = [label_baseline,
           label_u_arithmetic,
           label_r_uniform,
           label_r_zero]
...
formats_ = {'baseline':'-ok', 
           'u_arithmetic_average':'-^b', 
           'r_zero':'-*r',
           'r_uniform':'-*y'}
formats_ = {'baseline':'-k', 
           'u_arithmetic_average':'-b', 
