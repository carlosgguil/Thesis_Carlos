...
folder_manuscript='C:/Users/Carlos Garcia/Documents/GitHub/Thesis_Carlos/part2_developments/figures_ch6_lagrangian_JICF/params_quadtrees/profiles/'
...
folder_no_quad = folder + 'apte_model_calibration_u_vw_lognorm/k1_0p05_k2_1p0/store_variables/'
folder_quadtrees= folder + 'param_quadtrees/quadtrees_uvw_Dlognorm/store_variables/'

label_expe  = r'$\mathrm{Experiments}$'
label_no_quad = r'$\mathrm{No~quad.}$'
label_quadtrees = r'$\mathrm{With~quad.}$'

folders = [folder_no_quad,
           folder_quadtrees]

cases = ['no_quad',
         'quadtrees']

labels_ = [label_no_quad,
           label_quadtrees]
