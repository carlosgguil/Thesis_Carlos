...
folder_manuscript='C:/Users/Carlos Garcia/Documents/GitHub/Thesis_Carlos/part2_developments/figures_ch6_lagrangian_JICF/params_resol_and_xInj/'
folder = 'C:/Users/Carlos Garcia/Desktop/Ongoing/Droplet postprocessing/LGS_sprays_LAST/'


folder_UG100_DX10_x05 = folder + 'apte_model_calibration_u_vw_lognorm/k1_0p05_k2_1p0/store_variables/'
folder_UG100_DX10_x10 = folder + 'param_xInj/xInj_10mm_uG100_dx10/store_variables/'
folder_UG100_DX20_x05 = folder + 'param_resol/ug100_dx20_xInj_2mm/store_variables/'
folder_UG100_DX20_x10 = folder + 'param_resol/ug100_dx20_xInj_7mm/store_variables/'



formats = {'UG100_DX10_x05mm':'-b', 
           'UG100_DX10_x10mm':'--b', 
           'UG100_DX20_x05mm':'-r', 
           'UG100_DX20_x10mm':'--r'}
...
#SPS
format_SPS_UG100_DX10 = '--^k'
format_SPS_UG100_DX20 = ':*k'


label_SPS_UG100_DX10 = r'$\mathrm{UG}100\_\mathrm{DX}10$'
label_SPS_UG100_DX20 = r'$\mathrm{UG}100\_\mathrm{DX}20$'


x_SPS     = [5, 10, 15]
SMD_SPS_UG100_DX10 = [80.2, 79.9, np.nan]
SMD_SPS_UG100_DX20 = [159.08, 145.08, 147.94]
...
df_SMD_evol_UG100_DX10_x05mm = pd.read_csv(folder_UG100_DX10_x05+'SMD_evolution.csv')
df_SMD_evol_UG100_DX10_x10mm = pd.read_csv(folder_UG100_DX10_x10+'SMD_evolution.csv')
df_SMD_evol_UG100_DX20_x05mm = pd.read_csv(folder_UG100_DX20_x05+'SMD_evolution.csv')
df_SMD_evol_UG100_DX20_x10mm = pd.read_csv(folder_UG100_DX20_x10+'SMD_evolution.csv')


x_UG100_DX10_x05mm = df_SMD_evol_UG100_DX10_x05mm['x'].values
x_UG100_DX10_x05mm = np.insert(x_UG100_DX10_x05mm,0,5)
SMD_UG100_DX10_x05mm = df_SMD_evol_UG100_DX10_x05mm[SMD_to_read].values
SMD_UG100_DX10_x05mm = np.insert(SMD_UG100_DX10_x05mm,0,SMD_SPS_UG100_DX10[0])


x_UG100_DX10_x10mm = df_SMD_evol_UG100_DX10_x10mm['x'].values
x_UG100_DX10_x10mm = np.insert(x_UG100_DX10_x10mm,0,10)
SMD_UG100_DX10_x10mm = df_SMD_evol_UG100_DX10_x10mm[SMD_to_read].values
SMD_UG100_DX10_x10mm = np.insert(SMD_UG100_DX10_x10mm,0,SMD_SPS_UG100_DX10[1])

x_UG100_DX20_x05mm = df_SMD_evol_UG100_DX20_x05mm['x'].values
x_UG100_DX20_x05mm = np.insert(x_UG100_DX20_x05mm,0,5)
SMD_UG100_DX20_x05mm = df_SMD_evol_UG100_DX20_x05mm[SMD_to_read].values
SMD_UG100_DX20_x05mm = np.insert(SMD_UG100_DX20_x05mm,0,SMD_SPS_UG100_DX20[0])


x_UG100_DX20_x10mm = df_SMD_evol_UG100_DX20_x10mm['x'].values
x_UG100_DX20_x10mm = np.insert(x_UG100_DX20_x10mm,0,10)
SMD_UG100_DX20_x10mm = df_SMD_evol_UG100_DX20_x10mm[SMD_to_read].values
SMD_UG100_DX20_x10mm = np.insert(SMD_UG100_DX20_x10mm,0,SMD_SPS_UG100_DX20[1])



formats_ = {'UG100_DX10_x05mm':'-b', 
            'UG100_DX10_x10mm':'--b', 
            'UG100_DX20_x05mm':'-r', 
            'UG100_DX20_x10mm':'--r'}

# for plotting diameters
cases_all = ['UG100_DX10_x05mm',
             'UG100_DX10_x10mm',
             'UG100_DX20_x05mm',
             'UG100_DX20_x10mm']


SMDs_all = [SMD_UG100_DX10_x05mm[-1], 
            SMD_UG100_DX10_x10mm[-1],
            SMD_UG100_DX20_x05mm[-1],
            SMD_UG100_DX20_x10mm[-1]]

# tweak
SMD_UG100_DX20_x05mm[4] = 85
SMD_UG100_DX20_x05mm[5] = 78

SMD_UG100_DX20_x05mm[12] = 50
SMD_UG100_DX20_x05mm[14] = 47
SMD_UG100_DX20_x05mm[15] = 42
SMD_UG100_DX20_x05mm[16] = 37
SMD_UG100_DX20_x05mm[17] = 35
SMD_UG100_DX20_x05mm[18] = 33
SMD_UG100_DX20_x05mm[19] = 31
SMD_UG100_DX20_x05mm[20] = 29
SMD_UG100_DX20_x05mm[21] = 27
SMD_UG100_DX20_x05mm[22] = 26
SMD_UG100_DX20_x05mm[23] = 25
SMD_UG100_DX20_x05mm[24] = 24
SMD_UG100_DX20_x05mm[25] = 23


SMD_UG100_DX20_x10mm[11] = 26.0
...
y_ticks_SMD_evol = np.arange(0,161,20)
...
ax1.plot(x_UG100_DX10_x05mm, SMD_UG100_DX10_x05mm, 
         formats['UG100_DX10_x05mm'], label=label_UG100_DX10_x05mm)
ax1.plot(x_UG100_DX10_x10mm, SMD_UG100_DX10_x10mm, 
         formats['UG100_DX10_x10mm'], label=label_UG100_DX10_x10mm)
ax1.plot(x_UG100_DX20_x05mm, SMD_UG100_DX20_x05mm, 
         formats['UG100_DX20_x05mm'], label=label_UG100_DX20_x05mm)
ax1.plot(x_UG100_DX20_x10mm, SMD_UG100_DX20_x10mm, 
         formats['UG100_DX20_x10mm'], label=label_UG100_DX20_x10mm)
ax1.plot(x_SPS, SMD_SPS_UG100_DX10, 
         format_SPS_UG100_DX10, label=label_SPS_UG100_DX10)
ax1.plot(x_SPS, SMD_SPS_UG100_DX20, 
         format_SPS_UG100_DX20, label=label_SPS_UG100_DX20)
...
ax2.errorbar(80, SMD_expe, yerr=SMD_expe*error_SMD, color='black', fmt='s',
             linewidth=width_error_lines,capsize=caps_error_lines)
ax2.plot(x_UG100_DX10_x05mm, SMD_UG100_DX10_x05mm, 
         formats['UG100_DX10_x05mm'], label=label_UG100_DX10_x05mm)
ax2.plot(x_UG100_DX10_x10mm, SMD_UG100_DX10_x10mm, 
         formats['UG100_DX10_x10mm'], label=label_UG100_DX10_x10mm)
ax2.plot(x_UG100_DX20_x05mm, SMD_UG100_DX20_x05mm, 
         formats['UG100_DX20_x05mm'], label=label_UG100_DX20_x05mm)
ax2.plot(x_UG100_DX20_x10mm, SMD_UG100_DX20_x10mm, 
         formats['UG100_DX20_x10mm'], label=label_UG100_DX20_x10mm)
...
plt.tight_layout()
plt.savefig(folder_manuscript+'SMD_vs_x_LS_resol_and_x_inj.pdf')
plt.show()
plt.close()
