...
plt.title(labels_x_planes[j]+', '+labels_z_planes[k])
i = 0; plt.plot(y_values[i][j][k],u_to_plot[i][j][k],'k', label=f'{labels_cases[i]}')
i = 1; plt.plot(y_values[i][j][k],u_to_plot[i][j][k],'--k', label=f'{labels_cases[i]}')
i = 2; plt.plot(y_values[i][j][k],u_to_plot[i][j][k],'b', label=f'{labels_cases[i]}')
i = 3; plt.plot(y_values[i][j][k],u_to_plot[i][j][k],'r', label=f'{labels_cases[i]}')
