...
labels_cases = [r'$\mathrm{SPS}$' ,
                ...
                r'$\mathrm{LGS~ALM~baseline}$', 
                r'$2 F_\mathrm{DC}$', 
                r'$LGS~2 F_\mathrm{DC}$', 
                r'$3 F_\mathrm{DC}$', 
                r'$LGS~3 F_\mathrm{DC}$',
                r'$\mathrm{Custom~x=3~mm}$',
                r'$\mathrm{LGS~Custom~x=3~mm}$']
