...
folder_manuscript='C:/Users/Carlos Garcia/Documents/GitHub/Thesis_Carlos/part2_developments/figures_ch6_lagrangian_JICF/expe_validation_set_1/'
...
labels_ = [r'$\mathrm{Unperturbed}$', r'$\mathrm{ALM~original}$',
           r'$\mathrm{ALM~optimum}$', r'$\mathrm{Prescribed~inlet}$']


formats_ = ['r','b','g','y']
SMD_lim_along_z = (15,40)
ql_lim_along_z = (0,2.5)
z_lim = (0,21)
SMD_lim_along_y = (15,32)
...
dirs       = ["dx10_x05mm_wRMS_no_ALM","dx10_x05mm_wRMS" , 
              "dx10_x05mm_wRMS_FDC_times_01p5","custom_dx10_x02mm_wRMS"]
sols_dirs_name  = None
