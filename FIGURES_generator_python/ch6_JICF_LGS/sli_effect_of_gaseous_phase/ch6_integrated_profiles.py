...
plt.rcParams['lines.markersize'] = 25*FFIG #20*FFIG
...
folder_manuscript='C:/Users/Carlos Garcia/Documents/GitHub/Thesis_Carlos/part2_developments/figures_ch6_lagrangian_JICF/params_gaseous_initial_conditions/profiles/'
...
formats_ = {'prescribed':'-ok', 
           'no_ALM':'-^b', 
           'ALM_initial':'-*r',
           'ALM_FDC_0p24':'-*y',
           'ALM_FDC_0p30':'-*g'}

formats_ = {'prescribed':'-k', 
           'no_ALM':'-b', 
           'ALM_initial':'-r',
           'ALM_FDC_0p24':'-y',
           'ALM_FDC_0p30':'-g'}
