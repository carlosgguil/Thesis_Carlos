...
folder_manuscript='C:/Users/Carlos Garcia/Documents/GitHub/Thesis_Carlos/part2_developments/figures_ch6_lagrangian_JICF/params_dx_atom/profiles_ETAB/'
...
folder_dx10 = folder + '/param_dx_atom/dx_atom_10/store_variables/'
folder_dx16 = folder + '/param_dx_atom/dx_atom_16/store_variables/'
folder_dx00_ETAB = folder  + '/param_breakup_model/ETAB_u_vw_LN/store_variables/'
folder_dx10_ETAB = folder + '/param_dx_atom_ETAB/dx_atom_10/store_variables/'
folder_dx16_ETAB = folder + '/param_dx_atom_ETAB/dx_atom_16/store_variables/'

label_expe  = r'$\mathrm{Experiments}$'
label_dx00 = r'$\Delta x_\mathrm{atom} = 0~\mathrm{mm}$'
label_dx10 = r'$\Delta x_\mathrm{atom} = 10~\mathrm{mm}$'
label_dx16 = r'$\Delta x_\mathrm{atom} = 16~\mathrm{mm}$'
label_dx00_ETAB = r'$ETAB,~ 0~\mathrm{mm}$'
label_dx10_ETAB = r'$ETAB,~ 10~\mathrm{mm}$'
label_dx16_ETAB = r'$ETAB,~ 16~\mathrm{mm}$'
...
formats_ = {'dx00':'-k', 'dx10':'-b', 'dx16':'-r',
            'dx00_ETAB':'--k', 'dx10_ETAB':'--b', 'dx16_ETAB':'--r'}
...
z_ticks = [0,5,10,15,20,25,30,35,40]
