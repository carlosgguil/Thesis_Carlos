...
\nomenclature[A]{BF}{Band Flagging}
...
\nomenclature[A]{PDA}{Phase Doppler Anemometry}
...
\nomenclature[A]{RCT}{Reduced Computational Time}
...
\nomenclature[A]{WCT}{Wall Clock Time}
